...
class SubmitForm extends Mailable
{
    ...
    public function __construct($subject, $data, $files)
    {
        ...
        $this->words = [
            ...
            'smoking' => 'Smoking',
            'family_history_of_alapecia_check' => 'Family History of Alapecia Check',
            'family_history_of_alapecia' => 'Family History of Alapecia',
            'physical_exam_gender' => 'Physical Exam Gender',
            'physical_exam' => 'Physical Exam',
            'scolp' => 'Scolp',
            'quality_of_donor_hair' => 'Quality of Donor Hair',
            'elatiscity' => 'Elatiscity',
