...
import PrimaryLayout from './main/PrimaryLayout';
...
class PrimaryApp extends Component {
	...
	render() {
		...
		let component = <PrimaryLayout appBarTitle="Starters"
...
export default connect(mapStateToProps, mapDispatchToProps)(PrimaryApp);
