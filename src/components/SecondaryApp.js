...
import SecondaryLayout from './main/SecondaryLayout';
...
class SecondaryApp extends Component {
	...
	render() {
		...
		let component = <SecondaryLayout appBarTitle="Starters"
...
SecondaryApp.childContextTypes = {
...
const mapDispatchToProps = (dispatch) => ({
	actions: {
		...
		setLocale: bindActionCreators(IntlActions.setLocale, dispatch)
	}
});

export default connect(mapStateToProps, mapDispatchToProps)(SecondaryApp);
